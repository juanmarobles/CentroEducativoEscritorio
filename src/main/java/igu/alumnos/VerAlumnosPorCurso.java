...
public class VerAlumnosPorCurso extends javax.swing.JFrame {
    ...
    private void mostrarTablaAulas(Aula aulaSeleccionado) {
        ...
        String titulos[] = {"Aula", "Alumno","Apellido"};
        tabla.setColumnIdentifiers(titulos);
        if (listaAlumnos != null) {
            for (Alumno alumno : listaAlumnos) {
                Object[] objeto = {aulaSeleccionado.getAula(), alumno.getNombre(), alumno.getApellido()}; // Ajusta el campo para mostrar el nombre del alumno
                tabla.addRow(objeto);
            }
        } else {
