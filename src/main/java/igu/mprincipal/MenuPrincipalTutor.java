...
public class MenuPrincipalTutor extends javax.swing.JFrame {
    ...
    /**
     * Creates new form MenuPrincipalPadres
     */
    ...
    private void initComponents() {
        ...
        AsignarMateriaAlumno.setText("Horario y Aula");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuPrincipalTutor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuPrincipalTutor().setVisible(true);
            }
        });
    }
